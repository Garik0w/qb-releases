								...
								-- VEHICLES ABOVE ARE BLACKLISTED
									...
									if alertPolice == true then
										if SpeedKM > alertSpeed then
											...
											--TriggerServerEvent('esx_addons_gcphone:startCall', 'police', 'Eccesso di velocità, oltre i ' .. alertSpeed.. ' KMH', PlayerCoords, {
									...
									CashoutCore.Functions.Notify("you have been fined for speed exceeding maximum limit exceeded: 60KM", "error")
									
									if useBilling == true then
										--TriggerServerEvent('esx_bismacklling:sendBill', GetPlayerServerId(PlayerId()), 'society_police', 'Speedcamera (60KM/H)', 200) -- Sends a bill from the police
									else
						...
						if (GetPedInVehicleSeat(playerCar, -1) == playerPed) then					
							if hasBeenCaught == false then
								...
								-- VEHICLES ABOVE ARE BLACKLISTED
									...
									CashoutCore.Functions.Notify("you have been fined for speed exceeding maximum limit exceeded: 80KM.", "error")
						...
						if (GetPedInVehicleSeat(playerCar, -1) == playerPed) then 
							if hasBeenCaught == false then
								...
								-- VEHICLES ABOVE ARE BLACKLISTED
									...
									CashoutCore.Functions.Notify("you have been fined for speed exceeding maximum limit exceeded: 120KM.", "error")
