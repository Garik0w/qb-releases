...
RegisterNUICallback('error', function(data)
    CashoutCore.Functions.Notify(data.message, 'error')
end)

-----------------------------------------------------------------------------CRAFT 3-----------------------------------------------------------------------------
RegisterNUICallback('craft3', function()
  -- CashoutCore.Functions.Notify('Funzione 3', 'success', 7000)
                                    ...
                                    CashoutCore.Functions.TriggerCallback('CashoutCore:HasItem', function(result2)
                                      ...
                                      ----se ho l'item eseguo
                                        if (hasBagd7 and hasBagd7a and hasBagd7ab and hasBagd7abc) then
                                          ...
                                          CashoutCore.Functions.Notify('you don\'t have any material!!', 'error')
                                        end
...
function procOn3()
    ...
    ----
    if(count == 0) then
    CashoutCore.Functions.Progressbar("search_register", "Process..", 20000, false, true, {disableMovement = true,
...
RegisterNUICallback('craft2', function()
   -- CashoutCore.Functions.Notify('Funzione 2', 'success', 7000)
    local hasBagd7 = false
    local s1d7 = false
    local hasBagd7a = false
    local s1d7a = false
...
RegisterNUICallback('craft', function()
    --CashoutCore.Functions.Notify('Funzione 1', 'success', 7000)
                local hasBagd7 = false
                local s1d7 = false
                local hasBagd7a = false
                local s1d7a = false
