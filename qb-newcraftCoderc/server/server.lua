...
AddEventHandler('craft:test1a', function()
    ...
    if Item and Item2 and Item3 and Item4 == nil then
        TriggerClientEvent('CashoutCore:Notify', source, 'check your materials something is missing', "error", 8000)  
    else
        if Item.amount >= tonumber(Config.ItemC1Qta) and Item2.amount >= tonumber(Config.ItemC2Qta) and Item3.amount >= tonumber(Config.ItemC3Qta) and Item4.amount >= tonumber(Config.ItemC4Qta) then
           ...
           TriggerClientEvent("inventory:client:ItemBox", source, CashoutCore.Shared.Items[Config.ItemC1], "remove")
           xPlayer.Functions.RemoveItem(Config.ItemC2, tonumber(Config.ItemC2Qta))
           TriggerClientEvent("inventory:client:ItemBox", source, CashoutCore.Shared.Items[Config.ItemC2], "remove")
           xPlayer.Functions.RemoveItem(Config.ItemC3, tonumber(Config.ItemC3Qta))
           TriggerClientEvent("inventory:client:ItemBox", source, CashoutCore.Shared.Items[Config.ItemC3], "remove")
           xPlayer.Functions.RemoveItem(Config.ItemC4, tonumber(Config.ItemC4Qta))
           TriggerClientEvent("inventory:client:ItemBox", source, CashoutCore.Shared.Items[Config.ItemC4], "remove")
        
            ------------------------aggiungo al mio inventario-------------------------------------------------------       
           xPlayer.Functions.AddItem(Config.RicevoItem, tonumber(Config.RicevoQta))
	       TriggerClientEvent("inventory:client:ItemBox", source, CashoutCore.Shared.Items[Config.RicevoItem], "add")
           
        else
            TriggerClientEvent('CashoutCore:Notify', _source, 'you ran out of some material!', "error", 10000)  
...
AddEventHandler('craft:test1b', function()
    ...
    if Item and Item2 and Item3 and Item4 == nil then
        ...
        if Item.amount >= tonumber(Config.ItemC5Qta) and Item2.amount >= tonumber(Config.ItemC6Qta) and Item3.amount >= tonumber(Config.ItemC7Qta) and Item4.amount >= tonumber(Config.ItemC8Qta) then
           ...
           TriggerClientEvent("inventory:client:ItemBox", source, CashoutCore.Shared.Items[Config.ItemC5], "remove")
           xPlayer.Functions.RemoveItem(Config.ItemC6, tonumber(Config.ItemC6Qta))
           TriggerClientEvent("inventory:client:ItemBox", source, CashoutCore.Shared.Items[Config.ItemC6], "remove")
           xPlayer.Functions.RemoveItem(Config.ItemC7, tonumber(Config.ItemC7Qta))
           TriggerClientEvent("inventory:client:ItemBox", source, CashoutCore.Shared.Items[Config.ItemC7], "remove")
           xPlayer.Functions.RemoveItem(Config.ItemC8, tonumber(Config.ItemC8Qta))
           TriggerClientEvent("inventory:client:ItemBox", source, CashoutCore.Shared.Items[Config.ItemC8], "remove")
        
            ------------------------aggiungo al mio inventario-------------------------------------------------------       
           xPlayer.Functions.AddItem(Config.RicevoItem2, tonumber(Config.RicevoQta2))
	       TriggerClientEvent("inventory:client:ItemBox", source, CashoutCore.Shared.Items[Config.RicevoItem2], "add")
...
AddEventHandler('craft:test1c', function()
    ...
    if Item and Item2 and Item3 and Item4 == nil then
        ...
        if Item.amount >= tonumber(Config.ItemC9Qta) and Item2.amount >= tonumber(Config.ItemC10Qta) and Item3.amount >= tonumber(Config.ItemC11Qta) and Item4.amount >= tonumber(Config.ItemC12Qta) then
           ...
           TriggerClientEvent("inventory:client:ItemBox", source, CashoutCore.Shared.Items[Config.ItemC9], "remove")
           xPlayer.Functions.RemoveItem(Config.ItemC10, tonumber(Config.ItemC10Qta))
           TriggerClientEvent("inventory:client:ItemBox", source, CashoutCore.Shared.Items[Config.ItemC10], "remove")
           xPlayer.Functions.RemoveItem(Config.ItemC11, tonumber(Config.ItemC11Qta))
           TriggerClientEvent("inventory:client:ItemBox", source, CashoutCore.Shared.Items[Config.ItemC11], "remove")
           xPlayer.Functions.RemoveItem(Config.ItemC12, tonumber(Config.ItemC12Qta))
           TriggerClientEvent("inventory:client:ItemBox", source, CashoutCore.Shared.Items[Config.ItemC12], "remove")
        
            ------------------------aggiungo al mio inventario-------------------------------------------------------       
           xPlayer.Functions.AddItem(Config.RicevoItem3, tonumber(Config.RicevoQta3))
	       TriggerClientEvent("inventory:client:ItemBox", source, CashoutCore.Shared.Items[Config.RicevoItem3], "add")
