...
local blips = {
    {title="Cleaning dirty money", colour=1, id=500, x = 346.5, y = -998.27, z = 29.28}
        ...
        if dist <= 3.0 then
		    ...
		    if GetPedInVehicleSeat(vehicled, -1) == GetPlayerPed(-1) then
              ----se sono in macchina non esegue nessuna funzione
                ...
                -------------creo il testo-------------------------------------------------
                DrawText3Ds(sellX4, sellY4, sellZ4+0.1,'~g~[E]~w~ Clean up money')
                ---------------------------------------------------------------------------
                                        ...
                                        Citizen.Wait(100)
                                                  ...
                                                  ----se ho l'item eseguo
                                                    if (hasBagd7) then
                                                      ...
                                                      CashoutCore.Functions.Notify('You have no dirty money', 'error')
                                                    end
